...
public class ControllableKeyboard extends LinearLayout implements View.OnClickListener {
    ...
    // constructors
    public ControllableKeyboard(Context context) {
        this(context, null, 0);
    }

    public ControllableKeyboard(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ControllableKeyboard(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        // initialize buttons
        LayoutInflater.from(context).inflate(R.layout.keyboard_controllable, this, true);
